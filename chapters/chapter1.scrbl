...
@section[#:style section-title-style-numbered #:tag "rd"]{递推定义的数据}

编写过程代码时，必须明确知道什么样的值能作为过程的参数，什么样的值是过程的合法返
回值。这些值的集合通常很复杂。本节介绍定义值集合的形式化技术。

@subsection[#:style section-title-style-numbered #:tag "is"]{归纳定义法}
...
见出整个推理过程。下面的树状图叫做@elemtag["deriv-tree"]{@emph{推导}}
...
@subsection[#:style section-title-style-numbered #:tag "induct"]{归纳证明法}
...
@section[#:style section-title-style-numbered #:tag "drp"]{推导递归程序}
...
@subsection[#:style section-title-style-numbered #:tag "l-l"]{@tt{list-length}}
...
@subsection[#:style section-title-style-numbered #:tag "n-e"]{@tt{nth-element}}
...
@subsection[#:style section-title-style-numbered #:tag "r-f"]{@tt{remove-first}}
...
@subsection[#:style section-title-style-numbered #:tag "o-f"]{@tt{occurs-free?}}
...
@section[#:style section-title-style-numbered #:tag "apca"]{辅助过程和上下文参数}
...
@section[#:style section-title-style-numbered #:tag "ex"]{练习}
