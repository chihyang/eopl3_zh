...
新存储器则是尽量复制列表中需要的部分。代码如@figure-ref{fig-4.1}和4.2所示。
...
易读的形式。得出的日志详细描述了系统的动作。典型例子如@figure-ref{fig-4.4}和4.5所示。此外，这个
...
个表达式的跟踪日志如@figure-ref{fig-4.14}和@figure-ref{fig-4.15}所示。在本例中，@tt{x}、@tt{y}和@tt{z}最终都绑
定到位置5。
